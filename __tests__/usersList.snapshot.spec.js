...
import UsersList from '../src/js/components/UsersList';
...
describe('Users List(snapshot)', () => {
    it('should match Users List snapshot', () => {
        const component = renderer.create(<UsersList usersData={usersData}
                                                     perPage={10}
                                                     currentPage={0}/>);
